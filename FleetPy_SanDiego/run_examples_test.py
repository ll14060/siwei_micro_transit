...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        # sc = os.path.join(scs_path, "example_ir_only_1000_rq_5_veh.csv")  # 1,000 request 5 vehicle
        # sc = os.path.join(scs_path, "example_ir_only_1000_rq_10_veh.csv")   # 1,000 request 10 vehicle
        # sc = os.path.join(scs_path, "example_ir_only_1000_rq_20_veh.csv")   # 1,000 request 20 vehicle
        # sc = os.path.join(scs_path, "example_ir_only_1000_rq_30_veh.csv")   # 1,000 request 30 vehicle
        # sc = os.path.join(scs_path, "example_ir_only_1000_rq_40_veh.csv")   # 1,000 request 40 vehicle
        # sc = os.path.join(scs_path, "example_ir_only_1000_rq_100_veh.csv")   # 1,000 request 100 vehicle
