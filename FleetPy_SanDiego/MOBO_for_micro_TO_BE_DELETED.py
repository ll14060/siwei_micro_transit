...
def send_instruction(train_x):
    ...
    received_output_list = numpy.array(all_outputs).tolist()[0]
    received_other_metrics_list = numpy.array(other_metrics).tolist()[0]
...
#
#         data = s.recv(52097)
#         received_output_array, received_other_metrics_array = pickle.loads(data)
#         # received_output_tensor = torch.tensor(received_output, dtype=torch.double)
#         received_output_list = received_output_array.tolist()[0]
#         received_other_metrics_list = received_other_metrics_array.tolist()[0]
#
#         return received_output_list, received_other_metrics_list
...
N_BATCH = 25  # Number of iterations in optimization loop   # used 25 before
...
def evaluate_objectives(x_sorted):
    ...
    print(f"{Fore.RED}send_instruction is being called{Style.RESET_ALL}")
    _last_output, _last_other_metrics = send_instruction(input_data)
    end_time = time.time()
    duration = end_time - start_time
    log_path = "D:/Ritun/Siwei_Micro_Transit/Bayesian_Optimization/optimization_output/Ax_25_cents_6_var_28th_May_25" \
...
df.to_csv("D:/Ritun/Siwei_Micro_Transit/Bayesian_Optimization/optimization_output"
          "/Ax_25_cents_6_var_28th_May_25/optimization_result_new_method.csv", index=False)
# ----------------------------------------------------------------------------------------------------------------------
...
df_total_non_dom.to_csv("D:/Ritun/Siwei_Micro_Transit/Bayesian_Optimization/optimization_output/"
                        "Ax_25_cents_6_var_28th_May_25/non_dominated_data_old_method.csv", index=False)
# ----------------------------------------------------------------------------------------------------------------------
# Work on this part
...
df_total.to_csv("D:/Ritun/Siwei_Micro_Transit/Bayesian_Optimization/optimization_output/"
                "Ax_25_cents_6_var_28th_May_25/result_old_method.csv", index=False)
# ----------------------------------------------------------------------------------------------------------------------
# ----------------------------------------------------------------------------------------------------------------------
...
fig1.savefig('D:/Ritun/Siwei_Micro_Transit/Bayesian_Optimization/optimization_output'
             '/Ax_25_cents_6_var_28th_May_25/total_points.png', format='png', dpi=300)
plt.show()
...
fig2.savefig('D:/Ritun/Siwei_Micro_Transit/Bayesian_Optimization/optimization_output'
             '/Ax_25_cents_6_var_28th_May_25/non_dominant_points.png', format='png', dpi=300)
plt.show()
# ----------------------------------------------------------------------------------------------------------------------
...
fig3.savefig('D:/Ritun/Siwei_Micro_Transit/Bayesian_Optimization/optimization_output'
             '/Ax_25_cents_6_var_28th_May_25/hypervolume_plot.png', format='png', dpi=300)
plt.show()
